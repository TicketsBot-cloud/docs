...
If you need the bot to be in a language other than English, learn more about [language customisation](./language-customisation).

If not, let's start configuring the bot: [Bot Configuration](./configuration)
